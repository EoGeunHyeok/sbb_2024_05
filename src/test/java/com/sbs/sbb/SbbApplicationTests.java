...
class SbbApplicationTests {
	...
	void beforeEach() {
		...
		SiteUser user4 = userService.create("어근혁", "user4@test.com", "1234");
		SiteUser user5 = userService.create("박현철", "user5@test.com", "1234");
    ...
    */
	...
	void t011() {
		...
		assertEquals("네 자동으로 생성됩니다.", answerList.get(1).getContent());
	}
